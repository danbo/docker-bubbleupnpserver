...
exec "${JAVA}" -XX:+ExitOnOutOfMemoryError -XX:+CrashOnOutOfMemoryError -Xss256k -Djava.awt.headless=true -Djava.net.preferIPv4Stack=true -Dfile.encoding="UTF-8" -jar BubbleUPnPServerLauncher.jar $*
